package com.atguigu.streaming.practice.mocker

import java.util.{Properties, Random}

import com.atguigu.streaming.practice.bean.CityInfo
import com.atguigu.streaming.practice.utils.{PropertiesUtil, RanOpt, RandomOptions}
